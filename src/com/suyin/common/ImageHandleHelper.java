...
public class ImageHandleHelper {
	 ...
	 * @return
	 */
	public static synchronized String generateCode(String templateurl,String userCodeUrl,String outUrl,String userId, String userName) {  
	    Font font = new Font("微软雅黑", Font.PLAIN, 30);// 添加字体的属性设置  
	  	
	    String imgName = outUrl + userId + ".png";  
	    try {  
	        // 加载本地模板图片  
	    ...
	    imgName ="/resources/outImages/haibao/" + userId + ".png";  
	  
	    return imgName;  
	}  
	
	public static void main(String[] args) {
		String url=SystemPropertiesHolder.get("QRTEMP_PATH")+"oEWBhuH1TWxGFhibxzLM4XYtbDYo.jpg";
		File file=new File(url);
		String userId="1234";
		String userName="llllllz";
	    String projectUrl ="d:/sss/";//模板位置  
	    String requestUrl=SystemPropertiesHolder.get("QRTEMP_PATH");
		try{
//			generateCode(projectUrl,file.toString(),userId, userName);
		}catch(Exception ex){
