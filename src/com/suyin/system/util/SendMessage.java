...
{   
    ...
    */
     ...
     * @see
     */
    public static void withdrawalsPwdMsg(String phone,String message){
        ...
        map.put("password", "asdf123");//此处填写用户密码
        map.put("mobile",phone);//此处填写发送号码
        map.put("content", message+"为您修改提现密码的验证码，为保证您的账户安全，请勿外泄。如有疑问请致电400-8540505【NO团网】");
        map.put("apikey", "54c06118b0de262273492bf05e1997b5");
        HttpPost.doPost(sendMessageUrl, map,"GBK");
    }
...
//        sendMessage("18705164891", "李政");
        ...
        System.out.println(Tools.createRandom(6));    
    }
}
